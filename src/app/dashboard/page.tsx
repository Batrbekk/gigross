        ...
        return [
          {
            ...
            trend: String(dashboardData.overview.productsChange || '+0%').startsWith('+') ? 'up' : 'down',
            icon: Package,
            color: 'text-blue-600',
          },
          {
            ...
            trend: String(dashboardData.overview.activeLotsChange || '+0%').startsWith('+') ? 'up' : 'down',
            icon: Gavel,
            color: 'text-green-600',
          },
          {
            ...
            trend: String(dashboardData.overview.soldLotsChange || '+0%').startsWith('+') ? 'up' : 'down',
            icon: ShoppingCart,
            color: 'text-emerald-600',
          },
          {
            ...
            trend: String(dashboardData.overview.revenueChange || '+0%').startsWith('+') ? 'up' : 'down',
            icon: Wallet,
            color: 'text-purple-600',
          },
        ];
